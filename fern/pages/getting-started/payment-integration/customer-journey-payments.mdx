...
![Truemed eligibility widget on the product page](./images/payments-step-1-pdp-widget.png)
...
![Cart and checkout reinforcement signals for HSA/FSA eligibility](./images/payments-step-2-cart-reinforcement.png)
...
![Truemed shown as a payment method at checkout](./images/payments-step-3-method-selector.png)
...
![Truemed clinical intake form](./images/payments-step-4-intake.png)
...
![Truemed payment page for HSA/FSA card entry](./images/payments-step-5-card-entry.png)
...
![Sample LMN delivered by email](./images/payments-step-6-lmn-email.png)
