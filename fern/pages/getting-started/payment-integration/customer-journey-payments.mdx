...
<Tip>
Watch the [full payments walkthrough video](https://app.trupeer.ai/view/8lFYrQ8ht/truemed-payments-customer-experience) for a guided overview of every step below.
</Tip>
...
![Truemed eligibility widget on the product page](./images/customer-journey-payments-pdp-widget.png)
...
![Cart and checkout reinforcement signals for HSA/FSA eligibility](./images/customer-journey-payments-cart-reinforcement.png)
...
![Truemed shown as a payment method at checkout](./images/customer-journey-payments-method-selector.png)
...
![Truemed clinical intake form](./images/customer-journey-payments-intake.png)
...
![Truemed payment page for HSA/FSA card entry](./images/customer-journey-payments-card-entry.png)
...
![Sample LMN delivered by email](./images/customer-journey-payments-lmn-email.png)
