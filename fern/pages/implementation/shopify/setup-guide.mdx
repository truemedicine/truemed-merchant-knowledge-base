...
- ☐ Connected your bank account via Stripe (see the [Stripe Onboarding & Connection](/getting-started/stripe-setup/stripe-onboarding-connection) article)
...
<img src="https://files.buildwithfern.com/visual-editor-images/support.truemed.com/2026-04-14T23:40:14.033Z/implementation/shopify/setup-guide/image_(6).png" alt="image (6)" title="image (6)" noZoom={false} />
...
<Note>
**Recommended placement: directly below the product price.** The price is the one element that stays near the top of the page on nearly every theme, so anchoring the widget there keeps it above the fold and pairs the HSA/FSA message with the price shoppers are already evaluating. If your price isn't near the top of the page, place the widget wherever the price appears so the two stay visually paired.
</Note>
...
4. Add a **Custom Liquid** block **directly below the product price**
