...
- Increased AOV through pre-tax spending

- Fewer support questions about eligibility and process

Send HSA/FSA reminder emails **monthly or quarterly**, especially around:

- Open Enrollment (Oct–Dec)

- FSA expiration deadlines (Dec)

- New Year health resets (Jan)
...
- Eligible Customers Save an Average 30% Using HSA/FSA Funds

- Important Reminder: \[Product\] is HSA/FSA Eligible

- Savings Alert: Use HSA/FSA to Save an Average of 30% if Eligible

- Paying with HSA/FSA = 30% Average Savings on \[Product\] with Pre-tax Funds

**Seasonal**

- Reminder: Your FSA Dollars May Expire Soon

- Open Enrollment Tip: Save on \[Brand Name\]

- Max Out Your HSA Before Year-End

## **Email Templates**

### **One-Time Purchase Email**

> You may be able to use your **HSA or FSA** to buy \[Brand Name\]—and save an average of 30% using pre-tax dollars.\*
>
> These accounts were designed to help cover products and services that treat or prevent specific medical conditions. Truemed makes it easy to use them by following these steps:
>
...
> ****Learn more →**
> ****Truemed is on a mission to make true medicine affordable.**\
> You can learn more about them [here](https://www.truemed.com/).
>
...
> You may be eligible to use your **HSA or FSA** to get reimbursed for your \[Brand Name\] subscription—and save an average of 30% using pre-tax dollars.\*
>
> Truemed makes it simple to qualify and get reimbursed. Just follow these steps:
>
...
## **Some of Our Favorite Partner Emails:** 

![](https://cdn.applied.guide/media/886214b8-01bd-4c9d-8591-1d6ccbcc8c0e/7f11393d-b733-4862-a72d-ad8ada7fc9b9.png)
