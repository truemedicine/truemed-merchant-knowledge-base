...
- Promise approvals or imply certainty (no "guaranteed," "is eligible," "approved").
- Make **blanket brand/category** eligibility claims for mixed catalogs.
...
- Practitioner / clinician / healthcare provider
- Independent licensed practitioner (when helpful)
- Clinical intake form / health survey / medical questionnaire
...
**Exception (all/nearly all products eligible):**
...
- *30% average savings* framing with disclaimer.
- Optional context: *depending on tax bracket and state rules.*
...
- *Check HSA/FSA eligibility with Truemed*
- *HSA/FSA may be available for select items*

**Captions**

- *Use Truemed to see if your purchase qualifies for HSA/FSA. If eligible, pay with pre‑tax funds and save 30% on average.*
...
- *Pay with HSA/FSA funds and save 30% on average*
...
- *Qualify to use HSA/FSA funds on eligible products*.

### Black Friday / Cyber Monday

- *Maximize your savings with HSA/FSA funds this BFCM if eligible*.
- *x% Off Sitewide + Save an average of 30% when you pay with HSA/FSA*.
- *Stack Your Savings: \[Insert Sale\] + HSA/FSA* = Bigger Benefits\*.

### End‑of‑Year / FSA Expiration

- *Don’t let your FSA funds expire—shop eligible products today*.
- *Use it or lose it: FSA funds expire December 31*.
- *Save an average of 30% if eligible—use your FSA funds before they’re gone*.

### New Year, New You 

- *New Year’s resolutions? Invest in your health goals and save an average of 30% with HSA/FSA if eligible*.
- *Replenished benefits? Shop eligible products with your HSA/FSA if eligible*.
...
- *Save an average of 30% when you pay with HSA/FSA funds*.
- *Eligible customers save 30% on average with pre‑tax HSA/FSA dollars*.
- *Stack your savings: \[Sale\] + HSA/FSA = bigger benefits*.
...
2. **Savings framed as average with disclaimer?** (\~30% + combined disclaimer)
3. **Scope correct?** (product‑level for mixed catalogs; exception allowed only if nearly all products qualify)
4. **Precise terminology?** (practitioner, LMN, clinical intake form; no “doctor,” no “quick survey”)
5. **No third‑party guarantees?** (no outcome predictions)
