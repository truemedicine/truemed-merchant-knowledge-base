...
**How to submit to have your landing page built:**

Reach out to [merchants@truemed.com](mailto:merchants@truemed.com) to request a custom HSA/FSA landing page. Our team will build a branded page for you using your brand assets and suggested copy.
...
**Sample Launch Email Copy**

> Exciting news — we've partnered with Truemed to allow you to use your Health Savings Account (HSA) or Flexible Spending Account (FSA) on our site. This means that if qualified, you can pay for your membership with pre-tax dollars, resulting in net savings of 30% on average. 3 simple steps to get going:
>
> 1. Take a 2 minute evaluation survey from Truemed that will be reviewed by a licensed practitioner for a fee.
...
> Get reimbursed an average of 30% for the next year on your \[Merchant Name\] membership using your HSA/FSA. To get started, take a 2 minute survey and pay a fee: Qualify for HSA/FSA Spending \[CTA linking your survey link\]
***
## Website
...
> **INTRODUCING: TRUEMED**
>
> **USE YOUR HSA OR FSA TO SAVE ON CLASSES**
>
> With Truemed you can reimburse your \[Business] membership and class package purchases from your Health Savings Account (HSA) or Flexible Spending Accounts (FSA). Explore Truemed and confirm your eligibility.
>
> **LEARN MORE**
...
*Note: Link the CTA to your HSA/FSA landing page if you have one.*
***
...
Add the following copy to a content block on your app's homepage, and/or as a pop-up on your website.
