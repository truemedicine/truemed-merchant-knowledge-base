{/* Intercom article ID: 4657729 */}

---
title: HSA/FSA Landing Page
subtitle: Best practices for creating an HSA/FSA educational landing page to drive traffic and increase conversion.
---

![HSA/FSA landing page hero example](./images/landing-page-hero-example.jpeg)

## Why Create an HSA/FSA Educational Landing Page
...
Below is an example landing page that incorporates best practices. We've also provided a [figma file template](#figma-file-templates) with suggested copy to make it easy to create your own landing page.

![Landing page template example](./images/landing-page-template-example.png)
...
- Link to your landing page in the footers of marketing emails

![Navigation bar showing HSA/FSA link](./images/landing-page-nav-example.png)

### A Few Favorite Partner Landing Pages

- [Dose](https://dosedaily.co/pages/dose-is-hsa-fsa)
- [Apothekary](https://www.apothekary.co/blog/how-to-use-your-hsa-fsa-funds-at-apothekary)
- [Freak Athlete](https://freakathlete.co/pages/hsa-fsa-payments)
...
Need more guidance on what you can say about HSA/FSA? Review the **Compliant HSA/FSA Messaging Guide** and remember to add our required disclaimer with any savings claims.
...
- **URL** -- When building a page, use a short URL that includes the keyword and is less than 60 characters. Use hyphens to separate words, and keep the whole thing between 1-5 words. (e.g. `https://www.truemed.com/shop/red-light-therapy`)
- **SEO Title** -- Add a title tag of 60 characters or fewer with the target keyword (e.g. "Best Red Light Therapy Devices")
- **Meta Description** -- Add a 130-140-character meta description that answers the main question. (e.g. "Shop HSA/FSA-eligible red light therapy devices for skin, pain relief & muscle recovery at Truemed.")
...
![Above the fold example](./images/landing-page-above-the-fold.jpeg)
...
![FAQ section example](./images/landing-page-faq-section.jpeg)

<Tip>
Find FAQs to add to your page within our Figma [Landing Page Templates](#figma-file-templates).
</Tip>
...
- Link from relevant **product pages, collections, and articles**.
- Link from **newsletters, social, and campaigns** when talking about FSA/HSA, savings, or benefits.

![Internal linking example](./images/landing-page-internal-links.jpeg)
