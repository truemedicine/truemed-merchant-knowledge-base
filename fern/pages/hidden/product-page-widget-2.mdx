...
![](https://cdn.applied.guide/media/886214b8-01bd-4c9d-8591-1d6ccbcc8c0e/c70d0879-7e09-4bfe-bfa1-b6e303f68507.png)
...
To enable this feature, start by tagging your products in your Shopify dashboard. See Shopify Tag Docs.
...
4. Add space above or below the widget:
   ...
   Add `margin-top: #px;` to the style tags to add space to the top or `margin-bottom: #px;` to add space below the widget.

### **FAQs:**

a) Does this work for Shopify templates?

- Yes! From the Shopify admin panel, navigate to Online Store, then Themes, then Actions, then Edit Code, and look for your product template (usually called something like `main-product.liquid`). Or, send this page (along with your Public Qualification ID) to your Shopify developers.

b) Does this widget work for both Payment and Reimbursement integrations?
