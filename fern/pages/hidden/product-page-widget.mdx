...
3. Click **"Add block"**, then insert these 2 lines of HTML on your site, directly below the product price. Make sure to replace `YOUR_PUBLIC_QUALIFICATION_ID` with the ID from Step 1:
