...
subtitle: How to capture payments and manage order statuses for Truemed orders in your Shopify dashboard
---

{/* Intercom article ID: 6117185 */}
...
![Shopify payment capture settings](./images/shopify-payment-capture-settings.png)
...
![Payment pending status](./images/shopify-order-payment-pending.png)
...
![Authorized status](./images/shopify-order-authorized.png)
...
![Bulk capture from orders list](./images/shopify-bulk-capture.png)

![Capture payment button](./images/shopify-capture-payment-button.png)
...
![Paid status](./images/shopify-order-paid.png)

![Paid order detail](./images/shopify-order-paid-detail.png)
...
![Expired status](./images/shopify-order-expired.png)
...
[Truemed Capture Flow](https://file.notion.so/f/f/b8fb0fc4-c992-47dd-b1c1-08a966cc8387/a1b6e06e-4ef7-4beb-8eee-62e21d9eccaa/Truemed_Capture_Flow_%282%29.flow?table=block&id=27319734-f245-80b3-8267-d5ad9d59bb51&spaceId=b8fb0fc4-c992-47dd-b1c1-08a966cc8387&expirationTimestamp=1758592800000&signature=6YokaMPiN1p272oeeOJ20xYNnNiWtdjQNGhKp8-K4w4&downloadName=Truemed+Capture+Flow+%282%29.flow)
