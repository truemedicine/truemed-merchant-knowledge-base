...
<Note>
This overview is for merchants on the Truemed **payment API** integration. If you use the Shopify app, see the [Shopify](/dashboard-overview-payments) dashboard overview.
</Note>
...
![Truemed Dashboard Home page showing date controls, all-time totals, period metrics, and the revenue trend chart](./images/dashboard-api-home.png)
...
Export your product catalog as a CSV with the following fields, then upload it from the **Products** tab using **Upload CSV**, or use **Add Product** to add SKUs individually. Both Owners and Staff can upload, view, and download SKU data.
