...
If a customer chooses an HSA-eligible plan or opts into an FSA, they can spend pre-tax dollars on qualified health-related purchases—including your eligible memberships and fitness programs.

This means:

- Qualified customers save **\~30%** when using pre-tax, HSA/FSA funds
...
[**Email #1 Template**](https://viewstripo.email/template/bf109cf5-6fcf-4f0a-a6fe-d8c434319369)

[**Email #2 Template**](https://viewstripo.email/template/923a6d30-16bb-41a3-b96f-6cf7a427088c)

[**Email #3 Template**](https://viewstripo.email/template/90927fd6-3d90-4a9e-8f5c-2cf3c923edc6)
...
Both let you spend pre-tax income on eligible memberships & fitness programs—like some of those at \[Merchant Name\].

Qualified customers who reimburse their membership with pre-tax HSA/FSA funds using Truemed **save** **\~30%\***
...
**Header:**\
Use pre-tax money for memberships and fitness programs that support prevention
...
These accounts let you set aside pre-tax dollars for qualified health purchases—including eligible memberships & fitness programs from \[Brand Name\].

When paying with pre-tax HSA/FSA funds through Truemed, qualified customers **save \~30%\***.
...
Both let you use pre-tax dollars on eligible purchases—like some from your favorites from \[Brand Name\]. Qualified customers who reimburse their membership and fitness programs with pre-tax HSA/FSA funds using Truemed **save** **\~30%\*** with just a few extra steps.
...
- Add a homepage banner or callout during Open Enrollment with language like:\
  *“Open Enrollment is here—choose an HSA plan and save \~30% at checkout with Truemed.”*

Planning an open enrollment campaign and have questions? Feel free to email us at [merchants@truemed.com](mailto:merchants@truemed.com)